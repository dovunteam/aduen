...
const scopeText = {
  en: { eyebrow: 'Outside the prototype scope', title: 'Tuntiva should not prepare this case.', lede: 'The current prototype is limited to ordinary personal or household purchases by consumers in Malaysia. It will not force this case into a route that may not apply.', reasonsTitle: 'Why the workflow stopped', whatNext: 'What you can do', nextCopy: 'Review the details in case the purpose, location, or category was entered incorrectly. Otherwise, use an authoritative source or qualified adviser for the relevant sector. Tuntiva has not collected evidence for this case.', delete: 'Delete draft', review: 'Review case details' },
  ms: { eyebrow: 'Di luar skop prototaip', title: 'Tuntiva tidak sepatutnya menyediakan kes ini.', lede: 'Prototaip semasa terhad kepada pembelian biasa peribadi atau isi rumah oleh pengguna di Malaysia. Ia tidak akan memaksa kes ini ke dalam laluan yang mungkin tidak terpakai.', reasonsTitle: 'Mengapa aliran kerja dihentikan', whatNext: 'Tindakan yang boleh anda ambil', nextCopy: 'Semak butiran sekiranya tujuan, lokasi, atau kategori dimasukkan dengan salah. Jika tidak, gunakan sumber berautoriti atau penasihat yang berkelayakan untuk sektor berkenaan. Tuntiva belum mengumpul bukti untuk kes ini.', delete: 'Padam draf', review: 'Semak butiran kes' },
} as const
