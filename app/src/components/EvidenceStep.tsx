...
function riskLabel(risk: EvidenceRisk, locale: Locale) {
  ...
  return ({ card_number: 'Nombor kad pembayaran penuh mungkin terdapat dalam fail ini.', bank_account: 'Nombor akaun bank mungkin terdapat bersebelahan label akaun. Semak sama ada nombor itu perlu dikongsi.', authentication_secret: 'Fail ini menyebut kata laluan, PIN, OTP, frasa pemulihan atau kod sandaran, kod keselamatan kad (CVV/CVC), atau rahsia serupa.', identity_number: 'Fail ini mungkin mengandungi nombor dokumen pengenalan.', third_party_data: 'Fail ini nampaknya menyebut maklumat orang lain. Semak sama ada ia perlu disertakan.', contact_details: 'Fail ini mungkin mengandungi alamat e-mel atau nombor telefon bimbit Malaysia. Semak milik siapa maklumat ini dan sama ada ia diperlukan.', binary_unscanned: 'Imej atau PDF ini tidak diimbas untuk kandungan sensitif. Semak secara manual sebelum menyimpan atau berkongsi.', pdf_text_partial: 'Teks PDF yang boleh dicari (sehingga 500,000 aksara dalam 30 halaman) disemak untuk corak sensitif umum. Kandungan imbasan, imej sahaja, dan teks selebihnya mungkin tidak diliputi; semak setiap halaman secara manual.', ocr_partial: 'OCR tempatan menyemak kandungan teks yang terhad. OCR mungkin terlepas kandungan sensitif; semak imej atau setiap halaman secara manual.' } as const)[risk.code]
}
