...
type Props = { locale: Locale; draft: CaseDraft; onBack: () => void; onDelete: () => Promise<void>; hostedConfigured: boolean; signedIn: boolean; identityError: boolean; onSignIn: () => void | Promise<void>; onSaveHosted: () => Promise<void> }

export function DataControls({ locale, draft, onBack, onDelete, hostedConfigured, signedIn, identityError, onSignIn, onSaveHosted }: Props) {
