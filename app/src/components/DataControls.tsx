...
function auditLabel(event: LocalAuditEvent, locale: Locale): string {
  const labels = locale === 'ms'
    ? { consent_accepted: 'Terima notis privasi', case_edited: 'Edit kes', submission_edited: 'Edit serahan', derived_fact_reviewed: 'Semakan fakta terbitan', request_copied: 'Salin permintaan', pack_viewed: 'Lihat pek', pack_approved: 'Luluskan pek', evidence_inclusion_changed: 'Tukar penyertaan bukti', evidence_previewed: 'Pratonton bukti', evidence_downloaded: 'Muat turun bukti asal', redacted_copy_exported: 'Eksport salinan redaksi', evidence_deleted: 'Padam bukti', case_transitioned: 'Peralihan kes', case_exported: 'Eksport kes', pack_exported: 'Eksport pek', handoff_exported: 'Eksport serahan', follow_up_exported: 'Eksport peringatan susulan' }
    : { consent_accepted: 'Privacy notice accepted', case_edited: 'Case edited', submission_edited: 'Submission edited', derived_fact_reviewed: 'Derived fact reviewed', request_copied: 'Request copied', pack_viewed: 'Pack viewed', pack_approved: 'Pack approved', evidence_inclusion_changed: 'Evidence inclusion changed', evidence_previewed: 'Evidence previewed', evidence_downloaded: 'Original evidence downloaded', redacted_copy_exported: 'Redacted copy exported', evidence_deleted: 'Evidence deleted', case_transitioned: 'Case transitioned', case_exported: 'Case exported', pack_exported: 'Pack exported', handoff_exported: 'Handoff exported', follow_up_exported: 'Follow-up reminder exported' }
