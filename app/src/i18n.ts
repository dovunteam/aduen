...
export const messages = {
  en: {
    ...
    caseDetails: {
      ...
      purposeProblem: 'Purpose and problem', purposeProblemCopy: 'This affects which routes may apply.', purpose: 'Purchase purpose', selectPurpose: 'Select a purpose', personal: 'Personal, household, or domestic', business: 'Business or professional', category: 'Purchase category', selectCategory: 'Select a category', categories: [['general_goods', 'General goods'], ['general_services', 'General services'], ['aviation', 'Airline or airport'], ['financial_service', 'Financial service'], ['healthcare', 'Healthcare'], ['professional_service', 'Regulated professional service'], ['land', 'Land or property'], ['other', 'Other or uncertain']], issue: 'What went wrong?', selectIssue: 'Select the main issue', issues: [['non_delivery', 'Goods or services not received'], ['mismatch', 'Materially different from advertised'], ['missing_refund', 'Promised refund not received'], ['cancellation', 'Cancellation or billing problem'], ['uncertain', 'I am not sure']],
