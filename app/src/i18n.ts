...
export const messages = {
  en: {
    ...
    welcome: {
      ...
      notice: 'Aduen stores the case details and files you choose to enter in this browser on this device so you can organise a case and prepare a pack. Case information is not uploaded to Aduen: there is no account, sign-in, analytics, or case-data server. You can export or delete local data in Data controls. Browser clearing, device loss, or other people using this device may affect access or privacy. Aduen provides general routing information, not legal representation or a recovery guarantee.',
      consent: "I have read and understand this privacy and service notice, and confirm that I am authorised to provide the information in this case.",
    ...
    caseDetails: {
      ...
      transaction: 'Transaction', transactionCopy: 'Identify the consumer, purchase, and seller.', consumerName: 'Your name or chosen case name', consumerNamePlaceholder: 'Name used in the complaint', consumerLocation: 'Your location', selectLocation: 'Select a location', malaysia: 'Malaysia', outside: 'Outside Malaysia', seller: 'Seller or merchant', sellerPlaceholder: 'Business or seller name', sellerLocation: 'Seller location', selectKnown: 'Select if known', unknown: 'Unknown', platform: 'Platform', optional: 'Optional', platformPlaceholder: 'Website, marketplace, or app', purchaseDate: 'Purchase date', amount: 'Amount paid (MYR)', claimAmount: 'Estimated legal claim amount (MYR)', claimAccruedDate: 'Date the claim accrued', paymentMethod: 'Payment method', selectMethod: 'Select a method', methods: [['Card', 'Card'], ['Bank transfer', 'Bank transfer'], ['E-wallet', 'E-wallet'], ['Cash on delivery', 'Cash on delivery'], ['Other', 'Other']], reference: 'Order or reference number', referencePlaceholder: 'Order ID or receipt number',
  ...
  ms: {
    ...
    welcome: {
      ...
      notice: 'Aduen menyimpan butiran kes dan fail yang anda pilih untuk dimasukkan dalam pelayar pada peranti ini supaya anda boleh menyusun kes dan menyediakan pek. Maklumat kes tidak dimuat naik kepada Aduen: tiada akaun, log masuk, analitik atau pelayan data kes. Anda boleh mengeksport atau memadam data setempat dalam Kawalan data. Pemadaman data pelayar, kehilangan peranti atau penggunaan peranti ini oleh orang lain boleh menjejaskan akses atau privasi. Aduen menyediakan maklumat laluan umum, bukan perwakilan undang-undang atau jaminan pemulihan.',
      consent: 'Saya telah membaca dan memahami notis privasi dan perkhidmatan ini, dan mengesahkan bahawa saya diberi kuasa untuk memberikan maklumat dalam kes ini.',
