...
test('migrates an existing Tuntiva case, consent, and language preference to Aduen keys', async ({ page }) => {
  ...
  await expect.poll(() => page.evaluate(() => ({
    case: localStorage.getItem('Aduen.case-record.v1'),
    consent: localStorage.getItem('Aduen.consent.v1'),
    locale: localStorage.getItem('Aduen-locale'),
